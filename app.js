...
const t = {
  en: {
    ...
    dob:"My date of birth is...", postal:"My postal code is...",
    coverage:"Amount of protection (€)", term:"I want a Protection duration of (years)", smoker:"Am I a smoker?",
    sport:"I work out minimum… (times per week)", sport_ph:"Select a frequency per week (0–7)",
  ...
  de: {
    ...
    dob:"Ich bin geboren am...", postal:"<Meine Postleitzahl lautet...",
